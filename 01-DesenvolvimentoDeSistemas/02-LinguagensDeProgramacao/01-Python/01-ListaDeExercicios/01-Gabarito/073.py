...
print(f'Lista completa, ordenada, dos 20 colocados do Campeonato \
Brasileiro de 2018: {tabela2018}\n')
...
print(f'D) O Chapecoense está em {tabela2018.index("Chapecoense")+1}º \
lugar.')
