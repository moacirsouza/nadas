...
print('a) O nome informado, com todas as letras maiúsculas é: \
{}'.format(tudoMaiusculo))

print('b) O nome informado, com todas as letras minúsculas é: \
{}'.format(tudoMinusculo))

print('c) O total de letras do nome informado, sem contar os espaços é: \
{}'.format(totalDeLetras))

print('d) A quantidade de letras no primeiro nome é: \
{}'.format(comprimentoDoPrimeiroNome))
