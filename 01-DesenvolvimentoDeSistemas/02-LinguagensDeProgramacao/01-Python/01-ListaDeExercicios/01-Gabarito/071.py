...
#     if multiplicador == 1:
#         if valor < 5:
#             notas += str(valor) + ' nota(s) de 1.\n'
#         elif valor > 5:
#             notas += '1 nota de 5 e ' + str(valor%5) + ' nota(s) de 1.\n'
#         else:
#             notas += '1 nota de 5.\n'
#     # Validação da dezena
#     if multiplicador == 10:
...
#         elif 5 > valor >= 2:
#             if valor%2 == 0:
#                 notas += str(valor//2) + ' nota(s) de 20.\n'
#             else:
#                 notas += str(valor//2) + ' nota(s) de 20 e ' + str(valor%2) + ' nota(s) de 10\n'
#         elif valor > 5:
#             notas += '1 nota de 50 e '
#             if valor%5 >= 2:
#                 if (valor%5)%2 == 0:
#                     notas += str((valor%5)//2) + ' nota(s) de 20.\n'
#                 else:
#                     notas += str((valor%5)//2) + ' nota(s) de 20 e ' + str((valor%5)//2) + ' nota(s) de 10\n'
#             else:
#                 notas += '1 nota de 10.\n'
#         else:
#             notas += '1 nota de 50.\n'
...
while True:
    ...
    ### a cédula de valor imediatamente inferior, até zerar a variável
    ...
    if valorDoSaque >= cedula:
        ...
        ### preciso indicar que zero cédulas de um determinado valor serão
        ...
        ### imediatamente inferior, segundo a definição da Regra de Negócios.
        ### O conjunto de testes a seguir atinge esse propósito. Seja qual for
        ### o valor da cédula da iteração atual, uma das estruturas de controle
        ### vai capturá-lo e alterá-lo para próximo.
        if cedula == 50:
            cedula = 20
        elif cedula == 20:
            cedula = 10
        ...
        ### Depois de alterar o valor da cédula, o contaor precisa ser zerado,
