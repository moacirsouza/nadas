print("""
015) Escreva um programa que pergunte a quantidade de Km percorridos por um
...
custoFinal = (diasDeLocacao*custoDaLocacaoDiaria) + \
(quilometrosRodados*custoPorQuilometroRodado)

print('\nUm carro alugado por {} dia(s) e que rodou {} Km, custa um total de \
R$ {:.2f}.'.format(diasDeLocacao,quilometrosRodados,custoFinal))
