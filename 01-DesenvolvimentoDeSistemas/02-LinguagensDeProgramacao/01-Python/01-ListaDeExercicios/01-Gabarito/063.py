print("""
063) Escreva um programa que leia um número n inteiro qualquer e mostre
...
quantidadeDeTermos = int(input('Quantos termos da Sequência de Fibonacci \
você deseja mostrar: ').strip())
...
print('A sequência de Fibonacci com \
