print("""
023) Faça um programa que leia um número de 0 a 9999 e mostre na tela cada
...
### Observação: Se o um número com menos de 4 posições
### for informado, este método 'quebra', pois não espera
### que existam menos de 4 posições para a entrada.
