print("""
036) Escreva um programa para aprovar um empréstimo bancário para a compra
...
### Entrada do programa: Recebe o valor da casa e o salário do comprador como
### número real ("float") e o tempo de pagamento como inteiro ("int").
valorDoImovel = float(input('Informe o valor do imóvel: R$ ').strip())

salarioDoComprador = float(input('Informe o salário do(a) comprador(a): \
R$ ').strip())

tempoDePagamento = int(input('Informe o tempo de pagamento \
(Em anos): ').strip())
