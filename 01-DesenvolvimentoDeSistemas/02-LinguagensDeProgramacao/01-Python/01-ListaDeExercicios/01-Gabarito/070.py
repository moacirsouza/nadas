print("""
070) Crie um programa que leia o nome e o preço de vários produtos. O programa deverá
...
Há {} produto(s) mais caro(s) que R$ 1000.00""".format(nomeDoProdutoMaisBarato,
                                                       totalGastoNaCompra,
                                                       produtosMaisCarosQue1000)
)
